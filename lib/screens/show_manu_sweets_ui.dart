...
class ShowManuSweetsUI extends StatefulWidget {
  const ShowManuSweetsUI({Key? key}) : super(key: key);

  @override
  State<ShowManuSweetsUI> createState() => _ShowManuSweetsUIState();
}

class _ShowManuSweetsUIState extends State<ShowManuSweetsUI> {

  late Stream<QuerySnapshot> allManu;

  getAllManu() {
    allManu = apiGetAllManu2CoffeeShop()!;
  }
